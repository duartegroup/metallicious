...
folder_names = ['Ru_Pd_cage', 'Pd_Lusby','Co_cage', 'Fe_cage',  'Fe_knot',   'Ga_cage',  'Pd_fujita', 'Zn_knot']
uff_folders = ['Ga_cage', 'Ru_Pd_cage' ]
...
for basis_folder in ['10', 'TZVPP', 'wb97']:
    ...
    for idx, _ in list(enumerate(folder_names)):
        ...
        for idx_site in range(len(cage.sites)):
            cage.sites[idx_site].fp_coord_file = f'{name:}/template.pdb'
            cage.sites[idx_site].fp_topol_file = f'{name:}/template.top'
